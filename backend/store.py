...
_SEED_DEPT_CHILDREN = {
    ...
    "云产品六部": ["A1", "A2", "A3", "A4", "A5", "A6", "A7", "B1", "B2", "B3", "B4", "B5", "B6", "C1", "C2", "C3", "C4", "C5", "C6", "D1", "D2", "D3", "D4", "E1", "E2", "E3", "F1", "F2", "F3", "X1", "X2", "X3", "X4"],
    "云运营管理部": ["资源运营中心", "成本管理中心", "需求管理中心", "开发组"],
    "云采购供应管理部": ["商务一中心", "商务二中心", "商务三中心", "商务四中心", "供应中心", "业务管理中心", "平台开发中心", "宏观分析组"],
}
